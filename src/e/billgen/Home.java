...
public class Home extends JFrame implements ActionListener{
      String atype, meter;
       Home(String atype, String meter) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("images/elect3.jpg"));
        ...
        ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("images/icon7.png"));
